...
export const peopleSections: PeopleSection[] = [
  ...
  },
  {
    ...
    people: [
      {
        id: "shakib-sadat-shanto",
        name: "Shakib Sadat Shanto",
        role: "PhD Student",
        affiliation: "Computer Science, SCIS",
        photo: "/images/shakib_profile.png",
        interests: ["Generative AI", "Computing Education"],
        website: "https://shakib-sadat.github.io",
        hoverItems: [
          { emoji: "⚽️", label: "Soccer" },
          { emoji: "🎵", label: "Music" },
          { emoji: "🐈", label: "Cats" },
          { emoji: "🧑🏻‍💻", label: "Coding" },
        ],
      ...
      {
        id: "mariia-maksymenko",
        name: "Mariia Maksymenko",
        role: "Graduate Student",
        affiliation: "Computer Science, SCIS",
        photo: "/images/mariia_profile.jpg",
        interests: [
          "Computing Education",
          "Data Science",
          "AI",
    ...
    people: [
      {
        ...
        affiliation: "Computer Science & HCTD",
        photo: "/images/abby_profile.jpg",
      },
      {
        id: "william-dolley",
        name: "William Dolley",
        ...
        photo: "/images/will_profile.jpg",
        interests: ["Game Development", "Maybe Teaching"],
        hoverItems: [
          { emoji: "😴", label: "" },
          { emoji: "🐈", label: "" },
          { emoji: "⚽️", label: "" },
      ...
      },
      {
        ...
        name: "Natalie Olsen",
        role: "Undergraduate Student",
        affiliation: "Human-Centered Technology Design",
        photo: "/images/natalie_profile.jpg",
        hoverItems: [
          { emoji: "🌺", label: "" },
          { emoji: "🌄", label: "" },
          { emoji: "✨", label: "" },
...
export const researchOverview = {
  ...
  themes: [
    ...
    "Participatory Design with Learners and Educators",
  ],
};
